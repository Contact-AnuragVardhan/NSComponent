function generatePersonData(fromCount,toCount,hasNullValues) 
{
    // prepare the data
    var data = [];
    ...
    for (var count = fromCount; count < toCount; count++) 
    {
        var row = {};
        ...
        if (hasNullValues == true) {
            if (productindex % 2 != 0) {
                ...
                row["available"] = count % random == 0 ? null : false;
            }
        }
...
//http://demos.shieldui.com/web/grid-general/angularjs
var gridData = 
	[
	    {
	        "id": 0,
