...
nsModuleExport(this ?? globalThis,"NSMenu",NSMenu); "use strict";
...
nsModuleExport(this ?? globalThis,"NSPagination",NSPagination);
...
nsModuleExport(this ?? globalThis,"NSExport",NSExport);"use strict";
...
nsModuleExport(this ?? globalThis,"NSFilter",NSFilter);"use strict";
...
nsModuleExport(this ?? globalThis,"NSTouchToMouse",NSTouchToMouse); "use strict";
var NSVirtualScroll = (function()
{
	...
	NSVirtualScroll.prototype.dataSource = function(paramItems)
	{
		if(!this.util.isUndefinedOrNull(paramItems))
		{
			...
			if(reInit)
			{
				this.__internal.isItemHtml = this.util.isString(this.__internal.arrItem[0]);
				this.__setSize();
			}
			var scrollElement = this.__config.scrollElement;
			var scrollPos = scrollElement[this.__objSelectedProp.scroll];
			if(this.__internal.arrItem && (this.__internal.arrItem.length * this.__internal.itemDimension < scrollPos)) 
			{
	...
	NSVirtualScroll.prototype.__setInternalVars = function()
	{
		if(!this.__internal.itemDimension)
		{
			...
			if(this.__internal.arrItem && this.__internal.arrItem.length)
			{
				this.__internal.isItemHtml = this.util.isString(this.__internal.arrItem[0]);
				this.__setSize();
			}
	...
	NSVirtualScroll.prototype.__getItemSize = function()
	{
		...
		{
			var itemHtml = this.__internal.arrItem[0];
	...
	NSVirtualScroll.prototype.__addItems = function(arrItem)
	{
		arrItem = arrItem ? arrItem : this.__internal.arrItem;
		arrItem = arrItem || [];
	...
	NSVirtualScroll.prototype.__getAllItems = function()
	{
		if(this.__config.items && this.__config.items.length)
		{
			var arrItem = [];
			for(var count = 0;count < this.__config.items.length;count++)
			{
				arrItem.push(this.__config.items[count]);
			}
			return arrItem;
		}
		else if(this.__config.totalLength && this.__config.getItemComponent)
		{
			this.__internal.objItemComp = {};
			var arrItem = [];
			for(var count = 0;count < this.__config.totalLength;count++)
			{
				arrItem.push(this.__getItemFromComponent(count));
			}
			return arrItem;
		}
		return [];
	...
	NSVirtualScroll.prototype.__getPageData = function(arrItem,pageNum)
	{
		...
		var retItem = null;
		if(arrItem.length < internal.pageSize)
		{
			retItem = {startOffset: 0,endOffset: 0,itemsBefore: 0,arrItem:arrItem.length ? arrItem : [this.__getEmptyItem()]};
		}
		else
		{
	        ...
	        arrRet = arrItem.slice(startIndex,endIndex);
...
nsModuleExport(this ?? globalThis,"NSVirtualScroll",NSVirtualScroll);
"use strict"; 
...
nsModuleExport(this ?? globalThis,"NSFlatGrid",NSFlatGrid);
 "use strict"; 
...
nsModuleExport(this ?? globalThis,"NSHierarchicalGrid",NSHierarchicalGrid); "use strict";
...
nsModuleExport(this ?? globalThis,"NSGroupingGrid",NSGroupingGrid);
 "use strict"; 
		...
		if(arrSource) {
			for(var count = 0;count < arrSource.length;count++) {
				...
				if(!item[this.__nsGrid.__childField] || !item[this.__nsGrid.__childField].length) {
					...
					if(hasChildren) {
						var childItem = this.util.copyObjectWithNullValues(item);
	...
	NSMasterDetailGrid.prototype.__renderDetailCell = function(cell,item,parentItem,row)
	{
		if(cell && item) {
	        ...
	        if(!item[this.__detailCompElement] || !compInstance.renderEverytime || compInstance.renderEverytime(params)) {
	        	...
	        	this.__callComponentFunction(compInstance,"init",params,null,true);
	        	//compInstance.init(params);
...
nsModuleExport(this ?? globalThis,"NSMasterDetailGrid",NSMasterDetailGrid);"use strict";
...
nsModuleExport(this ?? globalThis,"NSGridEditor",NSGridEditor);
...
nsModuleExport(this ?? globalThis,"NSGridKeyboard",NSGridKeyboard);
...
nsModuleExport(this ?? globalThis,"NSGridSort",NSGridSort);
...
nsModuleExport(this ?? globalThis,"NSGridColumnResize",NSGridColumnResize);
...
nsModuleExport(this ?? globalThis,"NSGridColumnMove",NSGridColumnMove);
...
nsModuleExport(this ?? globalThis,"NSGridFilter",NSGridFilter);var NSList = (function()
{
...
nsModuleExport(this ?? globalThis,"NSList",NSList);
"use strict";
var NSGrid = (function()
{
...
nsModuleExport(this ?? globalThis,"NSGrid",NSGrid);