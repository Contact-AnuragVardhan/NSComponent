...
var NSEditor = (function()
{
	...
	NSEditor.prototype.initializeComponent = function() 
	{
		...
		this.__toolBarButton = {"bold":{html:"<i class='nse nse-bold' aria-hidden='true'></i>",tooltip:"Bold",tags: ["b", "strong"],css: {fontWeight: "bold"},shortKey:["ctrl+b"],command:"bold",showAsMenu: true},
				   "italic":{html:"<i class='nse nse-italics' aria-hidden='true'></i>",tooltip:"Italic",tags: ["i", "em"],css: {fontStyle: "italic"},shortKey: ["ctrl+i"],command:"italic",showAsMenu: true},
				   "underline":{html:"<i class='nse nse-underline' aria-hidden='true'></i>",tooltip:"Underline",tags: ["u"],css: {textDecoration: "underline"},shortKey: ["ctrl+u"],command:"underline",showAsMenu: true},
				   "strikeThrough":{html:"<i class='nse nse-strikethrough' aria-hidden='true'></i>",tooltip:"Strikethrough",tags: ["s", "strike"],css: {textDecoration: "line-through"},shortKey: ["ctrl+shift+s"],command:"strikeThrough",showAsMenu: true},
				   "justifyCenter":{html:"<i class='nse nse-align-center' aria-hidden='true'></i>",tooltip:"Justify Center",css: {textAlign: "center"},command:"justifyCenter"},
				   "justifyLeft":{html:"<i class='nse nse-align-left' aria-hidden='true'></i>",tooltip:"Justify Left",css: {textAlign: "left"},command:"justifyLeft"},
				   "justifyRight":{html:"<i class='nse nse-align-right' aria-hidden='true'></i>",tooltip:"Justify Right",css: {textAlign: "right"},command:"justifyRight"},
				   "justifyFull":{html:"<i class='nse nse-align-justify' aria-hidden='true'></i>",tooltip:"Justify Full",tags: ["s", "strike"],css: {textAlign: "justify"},command:"justifyFull"},
				   "subscript":{html:"<i class='nse nse-subscript' aria-hidden='true'></i>",tooltip:"Subscript",tags: ["sub"],command:"subscript",showAsMenu: true},
				   "superscript":{html:"<i class='nse nse-superscript' aria-hidden='true'></i>",tooltip:"Superscript",tags: ["sup"],command:"superscript",showAsMenu: true},
				   ...
				   "orderedList":{html:"<i class='nse nse-ordered-list' aria-hidden='true'></i>",tooltip:"Ordered List",command:"insertorderedlist",afterCommand:this.__orderedListHandler.bind(this),showAsMenu: true},
				   "unorderedList":{html:"<i class='nse nse-unordered-list' aria-hidden='true'></i>",tooltip:"Unordered List",command:"insertunorderedlist",afterCommand:this.__orderedListHandler.bind(this),showAsMenu: true},
				   "undo":{html:"<i class='nse nse-undo' aria-hidden='true'></i>",tooltip:"Undo",shortKey:["ctrl+z"],command:"undo",showAsMenu: true},
				   "redo":{html:"<i class='nse nse-redo' aria-hidden='true'></i>",tooltip:"Redo",shortKey:["ctrl+y"],command:"redo",showAsMenu: true},
				   "outdent":{html:"<i class='nse nse-decrease-indent' aria-hidden='true'></i>",tooltip:"Decrease Indent",command:"outdent",showAsMenu: true},
				   "indent":{html:"<i class='nse nse-increase-indent' aria-hidden='true'></i>",tooltip:"Increase Indent",command:"indent",showAsMenu: true},
				   "viewSourceCode":{html:"<i class='nse nse-source' aria-hidden='true'></i>",tooltip:"View Source Code",click: this.__viewSourceCodeHandler.bind(this),showAsMenu: true},
				   "clear":{html:"<i class='nse nse-new-doc' aria-hidden='true'></i>",tooltip:"Empty Document",click: this.__emptyDocHandler.bind(this),showAsMenu: true},
				   "print":{html:"<i class='nse nse-print' aria-hidden='true'></i>",tooltip:"Print",click: this.__printHandler.bind(this),showAsMenu: true},
				   "preview":{html:"<i class='nse nse-preview' aria-hidden='true'></i>",tooltip:"Preview",click: this.__previewHandler.bind(this),showAsMenu: true},
				   "pageBreakForPrinting":{html:"<i class='nse nse-bookmark' aria-hidden='true'></i>",tooltip:"Insert Page Break for Printing",click: this.__pageBreakForPrintingHandler.bind(this),showAsMenu: true},
				   "horizontalRule":{html:"<i class='nse nse-minus' aria-hidden='true'></i>",tooltip:"Insert Horizontal Line",command:"insertHorizontalRule",tags:["hr"],showAsMenu: true},
				   "fontFamily":{html:"<i class='nse nse-font' aria-hidden='true'></i>",tooltip:"Font Family",showAsMenu: true,
			   			isDropdown:true,
				   ...
				   "fontSize":{html:"<i class='nse nse-font-size' aria-hidden='true'></i>",tooltip:"Font Size",showAsMenu: true,
					   		    isDropdown:true,dataSource:[]},
				   "paragraphFormat":{html:"<i class='nse nse-paragraph' aria-hidden='true'></i>",tooltip:"Paragraph Format",showAsMenu: true,
					   			isDropdown:true,
 			       ...
 			       "align":{html:"<i class='nse nse-align-left' aria-hidden='true'></i>",tooltip:"Align",showAsMenu: true,
	 			    	  		isDropdown:true,
	 		       ...
	 		       "color":{html:"<i class='nse nse-font-color' aria-hidden='true'></i>",tooltip:"Font Color",showAsMenu: true,
	 						   isDropdown:true,dataSource:[]},
	 			   "backgroundColor":{html:"<i class='nse nse-background-color' aria-hidden='true'></i>",tooltip:"Background Color",showAsMenu: true,
		 					   isDropdown:true,dataSource:[]},
				 };
...
nsModuleExport(this ?? globalThis,"NSEditor",NSEditor);"use strict";
...
nsModuleExport(this ?? globalThis,"NSResizableTable",NSResizableTable);var NSTablePicker = (function()
{
...
nsModuleExport(this ?? globalThis,"NSTablePicker",NSTablePicker);"use strict"; 
...
nsModuleExport(this ?? globalThis,"NSTableUtil",NSTableUtil); var NSEditorUtil = (function()
{
...
nsModuleExport(this ?? globalThis,"NSEditorUtil",NSEditorUtil); var NSToolBar = (function()
{
	var NSToolBar = function(nsEditor)
	{
		...
		this.__getOverflowContainer = function()
		{
			if(!this.__groupedContainer)
			{
				...
				this.__btnGrouped.innerHTML = "<i class='nse nse-vertical-dots' aria-hidden='true'></i>"; 
...
nsModuleExport(this ?? globalThis,"NSToolBar",NSToolBar); var NSSelection = (function()
{
...
nsModuleExport(this ?? globalThis,"NSSelection",NSSelection); var NSExecCommand = (function()
{
...
nsModuleExport(this ?? globalThis,"NSExecCommand",NSExecCommand); var NSStack = (function()
{
...
nsModuleExport(this ?? globalThis,"NSStack",NSStack); var NSEditorModal = (function()
{
...
nsModuleExport(this ?? globalThis,"NSEditorModal",NSEditorModal); var NSEditorInlinePopup = (function()
{
...
nsModuleExport(this ?? globalThis,"NSEditorInlinePopup",NSEditorInlinePopup); var NSEditorUIFunc = (function()
{
...
nsModuleExport(this ?? globalThis,"NSEditorUIFunc",NSEditorUIFunc);var NSEditorFullScreen = (function()
{	
	var NSEditorFullScreen = function(nsEditor)
	{
		...
		{
			var self = this;
			this.__nsEditor.__toolBarButton["fullScreen"] = {html:"<i class='nse nse-expand' aria-hidden='true'></i>",tooltip:"Full Screen",showAsMenu: true,
												  ...
												  click:function(item,key,event)
												  {
													  ...
													  if(iTag)
													  {
														  if(self.util.hasStyleClass(iTag,"nse-expand"))
														  {
															  self.util.removeStyleClass(iTag,"nse-expand");
															  self.util.addStyleClass(iTag,"nse-collapse");
														  }
														  else
														  {
															  self.util.addStyleClass(iTag,"nse-expand");
															  self.util.removeStyleClass(iTag,"nse-collapse");
														  }
													  }
												  }};
		};
...
nsModuleExport(this ?? globalThis,"NSEditorFullScreen",NSEditorFullScreen);var NSEditorResize = (function()
{
...
nsModuleExport(this ?? globalThis,"NSEditorResize",NSEditorResize);var NSEditorLink = (function()
{	
	var NSEditorLink = function(nsEditor)
	{
		...
		this.setSettings = function()
		{
			...
			this.__nsEditor.__toolBarButton["link"] = {html:"<i class='nse nse-link' aria-hidden='true'></i>",tooltip:"Link",showAsMenu: true,
												  checkDisability: function(toolBarKey,toolBarItem,item,itemKey,isDefaultDisabled)
												  {
...
nsModuleExport(this ?? globalThis,"NSEditorLink",NSEditorLink);var NSEditorTable = (function()
{
	var NSEditorTable = function(nsEditor)
	{
		...
		{
			var self = this;
			this.__nsEditor.__toolBarButton["table"] = {html:"<i class='nse nse-table' aria-hidden='true'></i>",tooltip:"Table",showAsMenu: true,
												  checkDisability: function(toolBarKey,toolBarItem,item,itemKey,isDefaultDisabled)
												  {
													  if(itemKey === "viewSourceCode")
													  {
...
nsModuleExport(this ?? globalThis,"NSEditorTable",NSEditorTable);var NSFooterComp = (function()
{
...
nsModuleExport(this ?? globalThis,"NSFooterComp",NSFooterComp);  var NSElementResizer = (function()
{
...
nsModuleExport(this ?? globalThis,"NSElementResizer",NSElementResizer);var NSTablePluggins = (function()
{
	var NSTablePluggins = function(nsEditor)
	{
		...
		this.initialize = function()
		{
			this.__objMenu = { remove: {html: "<i class=\"nse nse-trash\" aria-hidden=\"true\"></i>",toolTip:"Remove",subMenu:this.__removeSubMenu,subMenuClickHandler:this.__removeClickHandler.bind(this)},
							   row: {html: "<i class=\"nse nse-bars\" aria-hidden=\"true\"></i>",toolTip:"Row",subMenu:this.__rowSubMenu,subMenuClickHandler:this.__rowClickHandler.bind(this)},
							   column: {html: "<i class=\"nse nse-layout\" aria-hidden=\"true\"></i>",toolTip:"Column",subMenu:this.__columnSubMenu,subMenuClickHandler:this.__columnClickHandler.bind(this)},
							   cell: {html: "<i class=\"nse nse-square\" aria-hidden=\"true\"></i>",toolTip:"Cell",subMenu:this.__cellSubMenu,subMenuClickHandler:this.__cellClickHandler.bind(this)},
							   alignment: {html: "<i class=\"nse nse-align-left\" aria-hidden=\"true\"></i>",toolTip:"Alignment",subMenu:this.__alignSubMenu,subMenuClickHandler:this.__alignClickHandler.bind(this)},
							   header: {html: "<i class=\"nse nse-header\" aria-hidden=\"true\"></i>",toolTip:"Table Header",menuClickHandler:this.__headerClickHandler.bind(this)},
							 };
		};
...
nsModuleExport(this ?? globalThis,"NSTablePluggins",NSTablePluggins);var NSEditorSearchReplace = (function()
{
	var NSEditorSearchReplace = function(nsEditor)
	{
		...
		{
			var self = this;
			this.__nsEditor.__toolBarButton["searchReplace"] ={html:"<i class='nse nse-search' aria-hidden='true'></i>",tooltip:"Search Or Replace",showAsMenu: true,
												   			isDropdown:true,
		...
		this.__setSearchContainer = function()
		{
			var html = "<div data-ns-ref=\"wrapper\" class=\"nsEditorSearchWrapper\">\r\n" + 
					...
					"					<span class=\"nsEditorSearchButtonIconWrap\">\r\n" + 
					"						<i data-ns-ref=\"moreoptionicon\" class=\"nse nse-expand-bold\" aria-hidden=\"true\"></i>\r\n" +
					"					</span>\r\n" + 
					"				</button>\r\n" + 
					"			</div>\r\n" + 
					"			<div class=\"nsEditorSearchButtonContainer\">\r\n" + 
					...
					"					<span class=\"nsEditorSearchButtonIconWrap\">\r\n" + 
					"						<i class=\"nse nse-close-bold\" aria-hidden=\"true\"></i>\r\n" +
					"					</span>\r\n" + 
					"				</button>\r\n" + 
					"			</div>\r\n" + 
					"		</div>\r\n" + 
		...
		this.__showReplaceComp = function(event)
		{
			if(!this.__isReplaceCompVisible())
			{
				...
				this.util.addStyleClass(this.__refsSearch.moreoptionicon,"nse-collapse-bold");
				this.util.removeStyleClass(this.__refsSearch.moreoptionicon,"nse-expand-bold"); 
			}
		};
		...
		this.__hideReplaceComp = function(event)
		{
			...
			this.util.removeStyleClass(this.__refsSearch.moreoptionicon,"nse-collapse-bold");
			this.util.addStyleClass(this.__refsSearch.moreoptionicon,"nse-expand-bold"); 
		};
...
nsModuleExport(this ?? globalThis,"NSEditorSearchReplace",NSEditorSearchReplace);