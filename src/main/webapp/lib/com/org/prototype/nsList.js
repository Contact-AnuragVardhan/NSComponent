	...
	NSList.prototype.__setNSVirtualScroll = function(source)
	{
		...
		else
		{
			if(length > 0)
			{
				...
				var setting = {scrollElement: this.__divOuterContainer,contentElement: this.__listContainer,itemTag: "li",totalLength: length,getItemComponent:this.__getItemComponentForVirtual.call(this),getEmptyItemComponent:this.__getEmptyItemComponentForVirtual.call(this),enableVariableRowHeight:this.__enableVariableRowHeight};
